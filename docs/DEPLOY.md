...
```json
{
  "mcpServers": {
    "lanhu": {
      "command": "node",
      "args": ["--env-file=/path/to/lanhu-mcp/.env", "/path/to/lanhu-mcp/dist/server.js"]
    }
  }
}
```
...
2. 查看本文档的故障排查章节
3. 提交 Issue: https://github.com/MrDgbot/lanhu-mcp/issues
4. 邮件联系: youngjimmy8305@gmail.com
